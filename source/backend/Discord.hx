...
class DiscordClient
{
	...
	private static final _defaultID:String = "1168945045060206602";
	...
	public static function changePresence(?details:String = 'where are we?', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "poop version: " + states.MainMenuState.psychEngineVersion;
