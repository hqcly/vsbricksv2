...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Bricked', 0.2], //From 0% to 19%
		['Stoned', 0.4], //From 20% to 39%
		['Chunked', 0.5], //From 40% to 49%
		['Tiled', 0.6], //From 50% to 59%
		['Slabbed', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBar.y + 55, FlxG.width - 800, "i feel bricky 2", 32);
	...
	function openChartEditor()
	{
		...
		#if DISCORD_ALLOWED
		DiscordClient.changePresence("fhart Editor", null, null, true);
	...
	function doDeathCheck(?skipHealthCheck:Bool = false) {
		if (((skipHealthCheck && instakillOnMiss) || health <= 0) && !practiceMode && !isDead)
		{
			...
			if(ret != LuaUtils.Function_Stop) {
				...
				if(autoUpdateRPC) DiscordClient.changePresence("youre done for - " + detailsText, SONG.song, iconP2.getCharacter());
				#end
				isDead = true;
				return true;
			}
