...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("duh extras", null);
		#end
		...
		bg = new FlxSprite().loadGraphic(Paths.image('menuBGfreeplay'));
		...
		var leText:String = "Space - Listen to song / CTRL - Gameplay Changers / RESET - Reset score";
		bottomString = leText;
		var size:Int = 16;
