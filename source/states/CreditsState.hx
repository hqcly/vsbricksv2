...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("who made this wonderful game?", null);
		#end
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['VS Bricks Team'],
			['HQC',		'HQC',		'Composer, Artist, Charter, Coder, Animator, Director, Owner',					 'https://hqc.carrd.co',		'00FFFF'],
			['Tod',				'Tod',			'Artist',						 'https://twitter.com/httptod',		'932232'],
